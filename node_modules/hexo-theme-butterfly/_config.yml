...
#   云盘: https://sionedrive.vercel.app || fas fa-cloud
#  私人||fas fa-coffee:
#   乱耳: /music/|| fas fa-music
#   捉影: /gallery/ || fas fa-camera
#   随念: https://tg.si-on.top/ || fas fa-paper-plane
...
social:
   fas fa-envelope: mailto:agapehydor2@gmail.com || Email
   fas fa-paper-plane: https://t.me/Siontine 
   fab fa-qq: http://wpa.qq.com/msgrd?v=3&uin=2322748973&site=qq&menu=yes
   fas fa-rss: https://si-on.top/atom.xml
...
# 还可以吧，恢复部署2022-3-19
  ...
  bg: https://cdn.jsdelivr.net/gh/aornus/blogimg/20220%20(1).gif # waline background
  visitor: false
  option:
    placeholder: 
    admin: 管理员
...
google_analytics: UA-220268456-1
...
theme_color:
  enable: true
  main: "#BEBEBE"
  paginator: "#000000" #49B1F5页码
  button_hover: "#408080"
  text_selection: "#408080"
  link_color: "#00B0B0"
  meta_color: "#858585"
  hr_color: "#BEBEBE" 
  ...
  toc_color: "#BEBEBE"
  blockquote_padding_color: "#BEBEBE"
  blockquote_background_color: "#BEBEBE"
# theme_color:
#   enable: true
#   main: "#49B1F5"
#   paginator: "#00c4b6"
...
canvas_nest:
  ...
  count: 4 # the number of lines, default: 99.线条数量
  mobile: falseDatalore Community plan
...
font:
    ...
    code-font-family: "Anonymous Pro"
...
# 左上角網站名字 主頁居中網站名字
blog_title_font:
  font_link: "https://fonts.googleapis.com/css2?family=Yuji+Syuku&display=swap"
  font-family: Noto Serif SC
#'Reggae One'
...
aside:
  ...
  card_announcement:
    enable: true
    content: 💎四月十九| 琐事繁杂，心神涣散，短暂放空，为期一月。
  card_recent_post:
    enable: false
...
inject:
  head:
    ...
    # - <link rel="stylesheet" href="https://unpkg.zhimg.com/static-butterfly/dist/css/index.min.css">
    # - <link rel="stylesheet" href="//unpkg.com/heti/umd/heti.min.css">
    # - <link href="https://fonts.proxy.ustclug.org/css2?family=Noto+Serif+SC:ital,wght@600;900&display=swap" rel="stylesheet">
    #- <link rel="preload" as="font" href="https://cdn.jsdelivr.net/gh/aornus/aornus.github.io@1.0/css/fonts/Noto_Serif_SC/NotoSerifSC-Regular.otf" type="font/otf" crossorigin="anonymous">
    #- <link rel="preload" as="font" href="https://cdn.jsdelivr.net/gh/aornus/aornus.github.io@1.0/css/fonts/Noto_Serif_SC/NotoSerifSC-Bold.otf" type="font/otf" crossorigin="anonymous">
    - <link href="https://fonts.googleapis.com/css2?family=Anonymous+Pro:ital,wght@0,400;0,700;1,400;1,700" crossorigin >
    ...
    - <meta name="baidu-site-verification" content="code-JsoFZlcau7" />
    #- <meta name="sogou_site_verification" content="Gzg8KZxJ83" />

  bottom:
  # - <script src="xxxx"></script>
  #- <script type="module" src="https://cdn.staticfile.org/three.js/r128/three.js"></script>
  #- <script type="module" scr="https://cdn.staticfile.org/three.js/r128/three.min.js"></script>
  #- <script type="module" src="https://cdn.staticfile.org/three.js/r128/three.module.js"></script>
  #- <script type="module" src="https://cdn.staticfile.org/three.js/r128/three.module.min.js"></script>
  # <script type="module" src="https://cdn.skypack.dev/three@r120"></script>
  # - <script type="text/javascript" src="/js/tikzjax.js"></script>
  #- <script src="/js/madethree.js"></script>
