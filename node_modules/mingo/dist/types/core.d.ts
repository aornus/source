...
export type AccumulatorOperator = (collection: RawObject[], expr: AnyVal, options?: Options) => AnyVal;
export type ExpressionOperator = (obj: RawObject, expr: AnyVal | RawObject | RawArray, options: Options) => AnyVal;
 ...
 */
export declare function getOperator(type: OperatorType, operator: string): Callback;
/**
