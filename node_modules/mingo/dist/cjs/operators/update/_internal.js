...
exports.walkExpression = exports.applyUpdate = exports.tokenizePath = void 0;
...
function walkExpression(expr, arrayFilter, callback) {
    const res = [];
    for (const [selector, val] of Object.entries(expr)) {
        ...
        if (!vars.length) {
            ...
            for (const [k, condition] of Object.entries(conditions)) {
                queries[k] = new query_1.Query(condition, options);
            }
