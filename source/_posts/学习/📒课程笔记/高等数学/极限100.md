...
提示：注意等价无穷小的条件
$$
folding,\ x^3\text{为无穷小},|\sin{\frac{1}{x^3}}|\le 1 \\
...
提示：拼凑等价无穷小
$$
\befoldinglim _{x \rightarrow 0} \frac{\sin x-\tan x}{x^{3}}\\
...
\end{equation}
$$
{% folding From Zhongxiang-17Days ,bg,purple %}
   提示：$1^{\infty}$型·第四弹
$$
\begin{aligned}
&\lim _{x \rightarrow \infty} \frac{(x+a)^{x+a}(x+b)^{x+b}}{(x+a+b)^{2 x+a+b}}\\
...
{% folding  Maclaurin series ,bg,green %}
$$
\begin{aligned}
...
这些是原始的等价无穷小，{% psw 亦可以看作出题者的后台,亦可以看作出题者的后台,#000000,#000000 %}
